...
- <nomComplet1>Matthieu Laurin</nomComplet1>
- <courriel1>Matthieu.Laurin.1@ens.etsmtl.ca</courriel1>
- <codeMoodle1>AT81990</codeMoodle1>
- <githubAccount1>MattLaurin</githubAccount1>
...
1. Le Système affiche le nom du joueur et le résultat de la partie, ainsi que le nombre de parties et le nombre de fois que le Joueur a gagné. Pour un lancer, si le total est inférieur à dix, le Joueur a gagné. Dans tous les autres cas, il a perdu.
